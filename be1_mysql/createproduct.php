...
// $create=$productModel->createProduct('hihi','aa',10,'hihi');
if (isset($_POST['productName'])) {
    $create = $productModel->createProduct($_POST['productName'], $_POST['productDescription'], $_POST['productPrice'], $_POST['productPhoto']);
    $message = '';
    if ($create) {
